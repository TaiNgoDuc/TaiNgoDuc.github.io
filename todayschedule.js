    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4) {
            ...
            for (let list of objects) {
                ...
                var i_mark = document.createElement('i');
                ...
                a_mark.setAttribute('data-target', '#markCompleteModal');

                ul.className = "action-list";

                i_edit.className = 'fa fa-edit';
                i_delete.className = 'fa fa-trash';
                i_mark.className = 'fa fa-check';
